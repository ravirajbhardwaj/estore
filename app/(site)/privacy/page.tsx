      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="drop-shadow-primary flex size-16 items-center justify-center rounded-2xl drop-shadow-lg">
              <HugeiconsIcon icon={KnightShieldIcon} />
            </div>
          </div>
        ...
        <Card className="border-muted/40 bg-muted/10 mb-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed">
            <p>
              Welcome to 1AI ("we," "our," or "us"). This Privacy Policy explains how we collect,
              use, disclose, and safeguard your information when you use our AI chat service and
              website.
            </p>
            <p>
              By using our service, you consent to the data practices described in this policy. If
        ...
        <Card className="border-muted/40 bg-muted/10 mb-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed">
            ...
            <ul className="space-y-2 list-disc list-inside">
              <li>
                <strong>Service Provision:</strong> To provide, maintain, and improve our AI chat
                services
              </li>
              <li>
              ...
              <li>
                <strong>Communication:</strong> To send important updates, security alerts, and
                support messages
              </li>
              <li>
                <strong>Personalization:</strong> To customize your experience and remember your
                preferences
              </li>
              <li>
              ...
              <li>
                <strong>Security:</strong> To detect, prevent, and address technical issues and
                security threats
              </li>
              <li>
        ...
        <Card className="border-muted/40 bg-muted/10 mb-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed">
            ...
            <ul className="space-y-2 list-disc list-inside">
              ...
              <li>
                <strong>Chat History:</strong> According to your preferences and applicable legal
                requirements
              </li>
              <li>
                <strong>Usage Logs:</strong> Typically retained for 12-24 months for security and
                analytics
              </li>
              <li>
                <strong>Payment Records:</strong> As required by applicable financial and tax
                regulations
              </li>
            </ul>
          </CardContent>
        ...
        <Card className="border-muted/40 bg-muted/10 mb-8">
          ...
          <CardContent className="space-y-4 text-foreground/90 leading-relaxed">
            ...
            <div className="bg-primary/10 border border-primary/20 rounded-lg p-4">
              <p>
                <strong>Email:</strong> privacy@1ai.co
              </p>
              <p>
