      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="text-center mb-12">
          <div className="flex justify-center mb-6">
            <div className="drop-shadow-primary flex size-16 items-center justify-center rounded-2xl drop-shadow-lg">
              <HugeiconsIcon icon={BalanceScaleIcon} />
            </div>
          </div>
        ...
        <Card className="border-muted/40 bg-muted/10">
          ...
          <CardContent className="space-y-6 text-foreground/90 leading-relaxed">
            <p>
              Welcome, if you continue to browse and use this website you are agreeing to comply
              with and be bound by the following terms and conditions of use, which together with
              our privacy policy govern 100xDevs relationship with you in relation to this website.
            </p>

            <p>
              The term 'Website name' or 'us' or 'we' refers to the owner of the website. The term
            ...
            <div>
              ...
              <ul className="space-y-3 list-disc list-inside">
                ...
                <li>
                  ...
                  and materials found or offered on this website for any particular purpose.
                </li>
                ...
                <li>
                  All trademarks reproduced in this website which is not the property of, or
                  licensed to, the operator is acknowledged on the website.
                </li>

                <li>
                  Unauthorized use of this website by you may give rise to a claim for damages
                  and/or be a criminal offense. From time to time this website may also include
                  links to other websites.
                </li>

                <li>
                  These links are provided for your convenience to provide further information. They
                  do not signify that we endorse the website(s). We take no responsibility for the
                  content of the linked website(s).
                </li>

                <li>
                  You may not create a link to this website from another website or document without
                  100xDevs prior consent.
                </li>
            ...
            <div>
              ...
              <ul className="space-y-3 list-disc list-inside">
                <li>
                  <strong>Credit Card Orders:</strong> Credit Card orders will commence on receiving
                  the authorization/confirmation from the Credit Card/respective Payment Gateway
                  companies.
                </li>

                <li>
                  <strong>Educational Purpose Only:</strong> This app is designed solely for
                  educational purposes to help users develop skills. We do not guarantee any income
                  or financial success from using this app.
                </li>

                <li>
                  <strong>No Income Assurance:</strong> The skills and knowledge provided are for
                  personal growth and learning. We do not promise or imply any job placement,
                  business success, or earnings.
                </li>

                <li>
                  <strong>Non-Refundable:</strong> All payments made in the app are final. No
                  refunds will be provided under any circumstances.
                </li>

                <li>
                  <strong>User Responsibility:</strong> You are responsible for how you use the
                  skills learned from this app. The app creators are not liable for any outcomes
